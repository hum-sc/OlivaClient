...
export function useYjsCollaboration(
  ...
  console.log("useYjsCollaboration: shouldBootstrap=",shouldBootstrap);
  const onBootstrap = useCallback(() => {
      const {root} = binding;
      console.log("Yjs: ",shouldBootstrap && root.isEmpty() && root._xmlText._length === 0)
...
function useProvider(
  ...
  useEffect(() => {
    ...
    const onSync = (isSynced: boolean) => {
        console.log("YJS: onSync: isSynced=",isSynced);
